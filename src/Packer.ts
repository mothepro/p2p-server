...
interface Codec {
    addExtPacker<T>(etype: number,
                    Class: new(...args: any[]) => T,
                    packer: ((t: T) => encodedBuffer) | ((t: T) => encodedBuffer)[]): void;

    addExtUnpacker<T>(etype: number,
 ...
 */
export function register<encInst, buff>(code: number,
 ...
 * @param cls
 */
export function registerError<T extends Error>(code: number,
